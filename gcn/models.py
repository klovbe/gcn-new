...
class CellGeneGCN(Model):
  ...
  def _loss(self):
    ...
    # Cross entropy error
    self.loss += masked_softmax_cross_entropy(self.outputs, self.input_data_dense['cell_labels'],
                                              self.input_data_dense['labels_mask'])


  def _accuracy(self):
    self.accuracy = masked_accuracy(self.probas, self.input_data_dense['cell_labels'],
                                    self.input_data_dense['labels_mask'])
